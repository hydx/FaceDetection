...
class Model():
    ...
    def conv_block(self, bottom, name, shape, strides=[1, 1, 1, 1], padding="SAME",
        ...
        if add_bn:
            ...
            pre_activation = tf.nn.batch_normalization(pre_activation, mean, variance, offset, scale,
    ...
    def conv_trans_layer(self, bottom, name, shape, strides=[1, 1, 1, 1], padding="SAME", has_bias=False):
        ...
        output_shape = tf.stack([nb, (h - 1) * strides[1] - 3 + shape[0], (w - 1) * strides[2] - 3 + shape[1], nc])[:,
                       0]
    ...
    def tiny_face(self, image):
        ...
        res3a_branch1 = self.conv_block(res2c, 'res3a_branch1', shape=[1, 1, 256, 512], strides=[1, 2, 2, 1],
                                        padding="VALID", add_relu=False)
        ...
        res4a_branch1 = self.conv_block(res3b3, 'res4a_branch1', shape=[1, 1, 512, 1024], strides=[1, 2, 2, 1],
                                        padding="VALID", add_relu=False)
